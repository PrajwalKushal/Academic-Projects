...
const int thresholdLeft = 90;  // Adjust this threshold to differentiate between black and white for the left sensor
const int thresholdRight = 150; // Adjust this threshold to differentiate between black and white for the right sensor
 
void setup()                                 // Built in initialization block
{
  servoRight.attach(11); // Attach the right servo to pin 12
  servoLeft.attach(10); // Attach the left servo to pin 13
...
{     
  ...
  if (!isLeftBlack && !isRightBlack) {
    ...
    servoRight.writeMicroseconds(1700); // Right wheel  Forward
        ...
        servoLeft.writeMicroseconds(1700); // Left wheel Turning Right
